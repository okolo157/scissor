  ...
  return (
    <>
      ...
      <div className="relative flex flex-col items-center w-full justify-center py-5 sm:py-8 min-h-screen px-4 sm:px-6 text-white overflow-hidden">
        ...
        >
          <ScissorShape size={70} color="#a855f7" />
        </motion.div>
        ...
        >
          <ScissorShape size={65} color="#ec4899" />
        </motion.div>
        ...
        >
          <ScissorShape size={85} color="#c084fc" />
        </motion.div>
        ...
        >
          <ScissorShape size={75} color="#a855f7" />
        </motion.div>
        ...
        >
          <ScissorShape size={80} color="#ec4899" />
        </motion.div>
        ...
        >
          <ScissorShape size={72} color="#c084fc" />
        </motion.div>
        ...
        >
          <ScissorShape size={68} color="#a855f7" />
        </motion.div>
